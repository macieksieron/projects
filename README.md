...
2) database - simple app for using datebase in MySQL from different access levels. 
3) paint - Simple Drawing Editor, instruction inside the app
4) simple logic calculator - app to calucalte results of 'and', 'or', 'implication' and 'iff' of 2 boolean variables.
5) snake - snake game
6) vildernes - basis for RPG game
